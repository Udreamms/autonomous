...
function getMessagingAdapter(platform) {
    switch (platform.toLowerCase()) {
        case 'whatsapp':
            return new whatsapp_1.WhatsAppAdapter();
        case 'messenger':
        case 'facebook':
            return new meta_1.MetaAdapter('messenger');
        case 'instagram':
            return new meta_1.MetaAdapter('instagram');
        case 'telegram':
